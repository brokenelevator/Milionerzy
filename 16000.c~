...
wrefresh(pion2up);
usleep(1500000);
mvwprintw(pion2up, (y2u/2)-2, ((x2u - 32)/2), "%s", "Do dynastii Andegawenow nale¿al?");
wrefresh(pion2up);
usleep(1500000);
...
wrefresh(pion2up);
usleep(1500000);
mvwprintw(pion2up, (y2u/2)-2, ((x2u - 46)/2), "%s", "Jak nazywa siê czterostrunowa gitara hawajska?");
wrefresh(pion2up);
usleep(1500000);
...
wrefresh(pion2up);
usleep(1500000);
mvwprintw(pion2up, (y2u/2)-2, ((x2u - 60)/2), "%s", "Podczas ktorego z kolei rejsu zatona³ transatlantyk Titanic?");
wrefresh(pion2up);
usleep(1500000);
