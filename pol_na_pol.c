...
if(prawidlodp==1)
	...
	if(polnpol==0)
		...
		odpc=0;
		odpd=0;
		mvwchgat(pion2up, (y2u/2)+2, ((x2u - 20)/2), 20, A_INVIS, 0, NULL);		
		mvwchgat(pion2up, (y2u/2)+3, ((x2u - 20)/2), 20, A_INVIS, 0, NULL);		
		}
	if(polnpol==1)
		{
		odpb=0;
		odpd=0;
		mvwchgat(pion2up, (y2u/2)+1, ((x2u - 20)/2), 20, A_INVIS, 0, NULL);		
		mvwchgat(pion2up, (y2u/2)+3, ((x2u - 20)/2), 20, A_INVIS, 0, NULL);		
		}
	if(polnpol==2)
		{
...
if(prawidlodp==2)
	...
	if(polnpol==1)
		...
		odpa=0;
		odpd=0;
		mvwchgat(pion2up, (y2u/2), ((x2u - 20)/2), 20, A_INVIS, 0, NULL);		
		mvwchgat(pion2up, (y2u/2)+3, ((x2u - 20)/2), 20, A_INVIS, 0, NULL);		
		}
	if(polnpol==2)
		{
