...
mvwchgat(pion2up, (y2u/2)+6, ((x2u - 21)/2), 21, A_INVIS, 6, NULL);
mvwchgat(pion2up, (y2u/2)+8, ((x2u/2)-10), 7, A_INVIS, 6, NULL);
mvwchgat(pion2up, (y2u/2)+8, ((x2u/2)+3), 7, A_INVIS, 6, NULL);
wrefresh(pion2up);
if(wy2b==2)
	{
	interfejs();
